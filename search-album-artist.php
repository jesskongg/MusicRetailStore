  ...
  <body class="page-top bg-primary">
    <div class="container text-center" style="height:100%">
      <div  class="text-center" style="height:50%;padding-top: 25%">
        <form action="search-album-name.php" method="post">
          <h2><i class='fa fa-dollar'></i> Search For the Price of the Album</h2>
          <h3>Select Artist Name First</h3>
          ...
          <div class="text-danger" style="padding-top: 2%">
            <?php
              ...
              $artists = $conn->query("SELECT DISTINCT Artist FROM MusicInfo");
